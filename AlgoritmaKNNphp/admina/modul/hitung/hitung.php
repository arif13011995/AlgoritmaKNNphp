 <!-- Content Header (Page header) -->
                <section class="content-header">
                    <h1>
                     Algoritma KNN - Klasifikasi Terlibat Korupsi
                    </h1>
                           <ol class="breadcrumb">
    ...
    <div class="col-lg-12"> 
        <div class="box box-solid box-primary">
                                 <div class="box-header">
                                    <h3 class="box-title">Masukkan Data Baru Untuk Diklasifikasikan </h3>
                  ...
                  <div class="box-body">
                     <form id="input" method="post" class="form-horizontal foto_banyak" action="<?=base_url();?>proses/blog.php">
...
<div class="form-group">
 ...
 <a href="<?=base_index();?>hitung/proses.php" class="btn btn-success btn-flat"><i class="fa fa-step-backward"></i> Kembali</a>
